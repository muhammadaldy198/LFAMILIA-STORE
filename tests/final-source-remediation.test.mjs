...
test("DOKU callback binds signature validation to one environment and acknowledges ignored signed callbacks", async () => {
  ...
  assert.match(callback, /expectedEnvironment: expectedOrder\?\.doku_environment/);
