...
const footerBanner = "/brand/lfamilia-footer-compact-v2.jpg";
...
test("brand PNG is transparent and the footer banner is a complete JPEG", () => {
  ...
  const banner = fs.readFileSync(path.join(root, "public", footerBanner));
