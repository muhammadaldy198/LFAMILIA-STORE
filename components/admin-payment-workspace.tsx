...
export function AdminPaymentWorkspace() {
  ...
  const load = useCallback(async () => {
    const [channelResponse, pageResponse, walletResponse] = await Promise.all([
    ...
    const [channelPayload, pagePayload, walletPayload] = await Promise.all([channelResponse.json(), pageResponse.json(), walletResponse.json()]) as [
