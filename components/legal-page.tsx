  ...
  return (
    <StoreLayout>
      <main className="mx-auto max-w-4xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        ...
        <div className="mt-8 border-b border-white/[0.08] pb-8"><p className="eyebrow !mb-0">{eyebrow}</p><h1 className="mt-3 text-4xl font-black tracking-[-0.05em] sm:text-5xl">{title}</h1><p className="mt-5 max-w-2xl text-sm leading-7 text-white/45">{intro}</p><p className="mt-4 flex items-center gap-2 text-[10px] text-white/28"><FileCheck2 className="size-3.5" /> Terakhir diperbarui: 29 Agustus 2026</p></div>
