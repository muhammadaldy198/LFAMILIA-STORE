...
export function NewsBrowser() {
  ...
  useEffect(() => { void fetch("/api/news", { cache: "no-store" }).then((response) => response.json()).then((data: { articles?: NewsRecord[] }) => setArticles(data.articles ?? [])).finally(() => setLoading(false)); }, []);
