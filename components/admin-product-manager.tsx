  ...
  return (
    <div className="admin-product-editor min-w-0 text-[#14213a]">
      ...
      {tab === "Nominal & Harga" || tab === "Tabel Pemisah" ? (
        ...
        <EditorTabPanel tab={tab} product={product} targetTemplate={targetTemplate} onSave={() => { onNotice(`${product.name} diperbarui.`); setMessage("Perubahan tampilan disimpan sementara di frontend."); }} />
      )}
