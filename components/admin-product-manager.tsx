        ...
        <DialogContent className="w-[calc(100vw-2rem)] max-w-[340px] gap-0 overflow-hidden rounded-xl border-white/10 bg-[#10141d] p-0 text-white sm:max-w-2xl">
          <form onSubmit={save} className="grid max-h-[68dvh] min-w-0 grid-rows-[auto_minmax(0,1fr)_auto] sm:max-h-[86vh]">
            ...
            <div className="grid min-w-0 gap-2.5 sm:grid-cols-2">
              ...
              <div className="sm:col-span-2"><AdminMediaUpload label="Gambar produk (wajib kotak 1:1)" value={draft.imageUrl ?? ""} onChange={(value) => updateDraft("imageUrl", value)} help="Gunakan gambar kotak 1:1, misalnya 1080 × 1080. Checkout dan pencarian menampilkan penuh; beranda otomatis memotong bagian tengah menjadi 2:3." previewClassName="h-20 sm:h-28" /></div>
