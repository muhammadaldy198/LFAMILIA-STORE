  ...
  return (
    <>
      ...
      <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
        <DialogContent className="max-h-[76dvh] w-[calc(100vw-2.5rem)] max-w-[360px] gap-3 overflow-y-auto overflow-x-hidden rounded-xl border-white/10 bg-[#10141d] p-3 text-white sm:max-h-[88vh] sm:w-full sm:max-w-2xl sm:p-5">
          <form onSubmit={save}>
