...
import { Gamepad2, Search, Ticket, X } from "lucide-react";
  ...
  return (
    <StoreLayout>
      <main className="mx-auto min-h-[70vh] max-w-7xl px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        <div className="max-w-2xl"><p className="eyebrow">Katalog produk</p><h1 className="section-title">Mau top up apa hari ini?</h1><p className="mt-4 text-sm leading-6 text-white/45 sm:text-base">Pilih game atau voucher, lalu coba alur pemesanan dengan data demo.</p></div>

        <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex gap-2 overflow-x-auto pb-1">
            {([
              ["all", "Semua", Search], ["game", "Game", Gamepad2], ["voucher", "Voucher", Ticket],
