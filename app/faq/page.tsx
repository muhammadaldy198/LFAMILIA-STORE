  ...
  return (
    <StoreLayout>
      <main className="mx-auto min-h-[70vh] max-w-4xl px-4 py-14 sm:px-6 sm:py-20 lg:px-8">
        ...
        <div className="mt-6 grid gap-3 sm:grid-cols-2"><div className="panel p-5"><Search className="size-5 text-[#b9ff35]" /><h2 className="mt-4 font-bold">Cek transaksi</h2><p className="mt-2 text-xs leading-5 text-white/36">Lihat status pesanan menggunakan nomor invoice.</p><Button asChild variant="outline" className="mt-5 rounded-xl border-white/10 bg-white/[0.025] text-xs text-white hover:bg-white/[0.08] hover:text-white"><Link href="/track">Lacak pesanan</Link></Button></div><div className="panel p-5"><Headphones className="size-5 text-[#b9ff35]" /><h2 className="mt-4 font-bold">Butuh bantuan lain?</h2><p className="mt-2 text-xs leading-5 text-white/36">Hubungi tim dukungan melalui halaman kontak LFAMILIA.</p><Button asChild variant="outline" className="mt-5 rounded-xl border-white/10 bg-white/[0.025] text-xs text-white hover:bg-white/[0.08] hover:text-white"><Link href="/contact">Hubungi kami</Link></Button></div></div>
      </main>
    </StoreLayout>
  );
}
