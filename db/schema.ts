...
export const productPackages = sqliteTable(
  "product_packages",
  {
    ...
    providerMaxPrice: integer("provider_max_price"),
...
export const orders = sqliteTable(
  "orders",
  {
    ...
    providerMaxPriceSnapshot: integer("provider_max_price_snapshot"),
    ...
    paymentGatewayMode: text("payment_gateway_mode"),
    paymentGatewayEnvironment: text("payment_gateway_environment"),
    gatewayRequestId: text("gateway_request_id"),
    gatewayReferenceNo: text("gateway_reference_no"),
    gatewayPaymentNo: text("gateway_payment_no"),
    gatewayQrContent: text("gateway_qr_content"),
    gatewayPaymentUrl: text("gateway_payment_url"),
    gatewayExpiredAt: text("gateway_expired_at"),
    gatewayStatusCheckedAt: text("gateway_status_checked_at"),
    dokuRequestId: text("doku_request_id"),
    dokuTokenId: text("doku_token_id"),
    dokuReferenceNo: text("doku_reference_no"),
    dokuPaymentNo: text("doku_payment_no"),
    dokuQrContent: text("doku_qr_content"),
    dokuPaymentName: text("doku_payment_name"),
    dokuPaymentUrl: text("doku_payment_url"),
    dokuExpiredAt: text("doku_expired_at"),
    dokuStatusCheckedAt: text("doku_status_checked_at"),
...
export const orderEvents = sqliteTable(
  "order_events",
  {
    ...
    source: text("source", { enum: ["doku", "midtrans", "wallet", "digiflazz", "voucher_stock", "admin"] }).notNull(),
...
export const walletSettings = sqliteTable("wallet_settings", {
  ...
  dokuTopupEnabled: integer("doku_topup_enabled", { mode: "boolean" }).notNull().default(false),
  dokuCheckoutEnabled: integer("doku_checkout_enabled", { mode: "boolean" }).notNull().default(false),
  updatedAt: text("updated_at").notNull().default(sql`CURRENT_TIMESTAMP`),
});
...
export const walletTopups = sqliteTable(
  "wallet_topups",
  {
    ...
    source: text("source", { enum: ["manual", "doku", "midtrans"] }).notNull().default("manual"),
    referenceId: text("reference_id"),
    externalCheckoutKey: text("external_checkout_key"),
    paymentGateway: text("payment_gateway"),
    paymentGatewayMode: text("payment_gateway_mode"),
    gatewayEnvironment: text("gateway_environment"),
    gatewayRequestId: text("gateway_request_id"),
    gatewayReferenceNo: text("gateway_reference_no"),
    gatewayPaymentNo: text("gateway_payment_no"),
    gatewayQrContent: text("gateway_qr_content"),
    gatewayPaymentName: text("gateway_payment_name"),
    gatewayPaymentUrl: text("gateway_payment_url"),
    gatewayExpiredAt: text("gateway_expired_at"),
    dokuRequestId: text("doku_request_id"),
    dokuTokenId: text("doku_token_id"),
