...
export const products: StoreProduct[] = [
  ...
  },
  {
    ...
    accent: "from-[#87d7e7] via-[#597db9] to-[#242b5b]", needsServer: true,
...
export const faqs = [
  ...
  { question: "Metode pembayaran apa yang tersedia?", answer: "Rencana awal menggunakan QRIS melalui Midtrans. Metode lain dapat ditambahkan kemudian dari panel pembayaran." },
  ...
  { question: "Di mana saya bisa melihat status pesanan?", answer: "Buka menu Cek Transaksi dan masukkan nomor invoice. Selama mode demo, gunakan DEMO-20260828-001." },
];
